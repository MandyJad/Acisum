package br.com.acisum.util.converter;
...
import br.com.acisum.domain.GenericDomain;
...
public class PrimeFacesPickListConverter implements Converter {
        ...
        if (arg1 instanceof PickList) { 
            ...
            for (Iterator iterator = dl.getSource().iterator(); iterator 
                ...
                String id = (new StringBuilder()).append( 
                        ((GenericDomain) o).getId()).toString(); 
                if (arg2.equals(id)) { 
                    ret = o; 
                    break; 
                } 
    ...
    public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) { 
        String str = ""; 
        if (arg2 instanceof GenericDomain) 
            str = ((GenericDomain) arg2).getId().toString(); 
        return str; 
    }
}
